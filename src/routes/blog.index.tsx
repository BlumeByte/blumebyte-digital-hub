  ...
  head: () => ({
    meta: [
      { title: "Insights — Blumebyte" },
      {
        name: "description",
        content:
          "Practical writing on AI, digital transformation, infrastructure, dashboards and software for growing organisations.",
      },
    ],
  }),
  component: BlogPage,
        ...
        <div className="container-page section-shell grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          ...
          <Reveal delay={100}>
            <p className="max-w-xl text-base leading-8 text-white/64 sm:text-lg">
              Notes on AI, software, infrastructure and digital operations for teams that want
