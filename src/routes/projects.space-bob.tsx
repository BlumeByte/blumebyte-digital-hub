  ...
  head: () => ({
    meta: [
      { title: "Space Bob — Blumebyte Portfolio" },
      {
        name: "description",
        content:
          "Space Bob is a published Android mobile game from Blumebyte, available through Google Play.",
      },
    ],
  }),
...
const capabilities = [
  {
    icon: Smartphone,
    title: "Published on Android",
    body: "Space Bob is available through the supplied Google Play listing.",
  },
  {
    icon: Gamepad2,
    title: "Mobile game development",
    body: "A public example of Blumebyte's work beyond business software and websites.",
  },
  {
    icon: Rocket,
    title: "Consumer product work",
    body: "Part of Blumebyte's experimentation with interactive products designed for everyday mobile use.",
  },
];

function SpaceBobPage() {
  const project = projects.find((item) => item.slug === "space-bob")!;
  return (
    <>
        ...
        <div className="container-page section-shell grid gap-12 lg:grid-cols-[1fr_.85fr] lg:items-end">
          <Reveal>
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#d5b16b]">
              Published Android game · Blumebyte
            </p>
          ...
          <Reveal delay={100}>
            <p className="max-w-xl text-base leading-8 text-white/64 sm:text-lg">
              Space Bob is a Blumebyte mobile game for Android and a public example of the company's
              game-development and interactive product work.
            </p>
            <Button asChild variant="hero" size="lg" className="mt-8 rounded-full">
              <a href={siteConfig.products.spaceBobPlayStore} target="_blank" rel="noreferrer">
                Download on Google Play <ArrowUpRight />
              </a>
            </Button>
          </Reveal>
        </div>
