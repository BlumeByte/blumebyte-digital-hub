...
const features = [
  {
    ...
    body: "Keep employee profiles, contacts, roles and key information together in one organised workspace.",
  },
  {
    icon: CalendarCheck,
    title: "Leave management",
    body: "Handle leave requests, balances and approvals with a clearer workflow for staff and managers.",
  },
  {
    icon: Clock,
    title: "Attendance",
    body: "Support day-to-day attendance tracking and visibility across the organisation.",
  },
  {
    icon: Wallet,
    title: "Payroll workflows",
    body: "Bring payroll-related inputs and approvals into a more structured process.",
  },
  {
    icon: FileText,
    title: "Documents",
    body: "Keep contracts, policies, certificates and employee documents easier to find and manage.",
  },
  {
    icon: ShieldCheck,
    title: "Roles & permissions",
    body: "Give HR, managers and employees access appropriate to the work they need to do.",
  },
];

function BlumebyteHR() {
  const project = projects.find((item) => item.slug === "blumebyte-hr")!;
  return (
    <>
        ...
        <div className="container-page section-shell grid gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <Reveal>
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-white/64 sm:text-lg">
              Blumebyte HR is a practical HR platform for growing organisations that want employee
              records, leave, attendance and everyday people workflows in one place.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                <a href={siteConfig.products.hr} target="_blank" rel="noreferrer">
          ...
          <div className="grid gap-8 lg:grid-cols-[.65fr_1.35fr]">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.055em] sm:text-5xl">
                The everyday HR work, made clearer.
              </h2>
            </div>
        ...
        <div className="container-page section-shell grid gap-12 lg:grid-cols-2">
          <Reveal>
            ...
            <h2 className="mt-4 max-w-xl text-4xl font-semibold tracking-[-0.055em] sm:text-5xl">
              For organisations ready to move beyond scattered HR processes.
            </h2>
          </Reveal>
          <Reveal delay={80}>
            <p className="max-w-xl text-base leading-8 text-muted-foreground">
              Blumebyte HR is designed for teams that want more structure around employee
              information and HR workflows without making the system itself difficult to operate.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild variant="hero" size="lg" className="rounded-full">
                <Link to="/contact">
