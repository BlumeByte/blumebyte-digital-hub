...
export const services: Service[] = [
  {
    ...
    short:
      "Modern responsive websites and intelligent dashboards that streamline operations.",
    description:
  ...
  },
  {
    ...
    icon: Gamepad2,
    highlights: ["Android & iOS apps", "Interactive game experiences", "Analytics and release support"],
  },
  {
  ...
  },
  {
    ...
    icon: Boxes,
    highlights: ["Project & document management", "Process automation", "Team onboarding & training"],
  },
  {
